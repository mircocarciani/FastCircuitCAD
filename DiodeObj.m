classdef DiodeObj < ComponentObj
    ...
    methods
        ...
        function this  = DiodeObj(SchManager, compName,compXo,compYo)
            
            this@ComponentObj(SchManager,compName,compXo,compYo,EComponentType.Diode)
        ...
        function CreateGrObj(this)
            ...
            X = [X, NaN, 0 -2 2 0];
            Y = [Y, NaN,2 -2 -2 2];
            diode = line(X,Y,'Parent',this.GrObj,'LineWidth',1.5,'Tag','body');
            diode.HitTest = 'off';
            diode.UserData.Defaults.XData = X;
            diode.UserData.Defaults.YData = Y;
